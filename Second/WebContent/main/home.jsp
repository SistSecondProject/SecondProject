				...
				<div>
					<div class="section-header">
						...
						<table class="table table-striped">
							<tr>
								<th width=20% class="text-center">4월 25일</th>
								<th width=20% class="text-center">4월 26일</th>
								<th width=20% class="text-center">4월 27일</th>
								<th width=20% class="text-center">4월 28일</th>
								<th width=20% class="text-center">4월 29일</th>
							</tr>
						</table>
					</div>
				</div>
